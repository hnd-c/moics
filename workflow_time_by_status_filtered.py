...
print("="*80)
print("WORKFLOW TIME DISTRIBUTION - FILTERED APPROVAL VERSIONS")
print("="*80)
print()
...
# Status categories with 4 versions of approved + rejected + inprocess
status_categories = {
    'approved_all': {
        'name': 'Approved (All)',
        'filter_func': lambda final_status, final_level, days_dormant: final_status == 1,
        'color': 'seagreen',
        'description': 'All applications with final status = 1',
        'confidence': 'Mixed - includes potential intermediate approvals'
    },
    'approved_l4plus': {
        'name': 'Approved (L4+)',
        'filter_func': lambda final_status, final_level, days_dormant: final_status == 1 and final_level >= 4,
        'color': 'darkgreen',
        'description': 'Applications approved at Level 4 or higher',
        'confidence': 'HIGH - Reached senior approval levels'
    },
    'approved_l4plus_or_dormant': {
        'name': 'Approved (L4+ or Dormant)',
        'filter_func': lambda final_status, final_level, days_dormant: final_status == 1 and (final_level >= 4 or days_dormant > 180),
        'color': 'mediumseagreen',
        'description': 'Applications approved at L4+ OR no activity for 180+ days',
        'confidence': 'HIGH - Best balance of completeness and confidence'
    },
    'approved_l6plus': {
        'name': 'Approved (L6+)',
        'filter_func': lambda final_status, final_level, days_dormant: final_status == 1 and final_level >= 6,
        'color': 'forestgreen',
        'description': 'Applications approved at Level 6 or higher only',
        'confidence': 'VERY HIGH - Ultra-confident final approvals'
    },
    'rejected': {
        'name': 'Rejected',
        'filter_func': lambda final_status, final_level, days_dormant: final_status in [2, 3],
        'color': 'crimson',
    ...
    'inprocess': {
        'name': 'In-Process',
        'filter_func': lambda final_status, final_level, days_dormant: final_status == 0,
        'color': 'darkorange',
...
def calculate_application_data_by_status(process_name, status_category):
    ...
    filtered by final status category with enhanced filtering criteria.
    """
    ...
    # Filter applications by final status with additional criteria
    filtered_app_ids = []
    for app_id in app_ids:
        ...
        if category_info['filter_func'](final_status, final_level, days_dormant):
...
print("Starting analysis with 4 approval versions + rejected + in-process...")
print()
...
print()
print("APPROVED VARIANTS (4 versions):")
print("  • *_approved_all_distribution.png - All approved (baseline)")
print("  • *_approved_all_transitions.png")
print("  • *_approved_l4plus_distribution.png - High confidence (L4+)")
print("  • *_approved_l4plus_transitions.png")
print("  • *_approved_l4plus_or_dormant_distribution.png - Recommended filter (L4+ or dormant 180d)")
print("  • *_approved_l4plus_or_dormant_transitions.png")
print("  • *_approved_l6plus_distribution.png - Ultra-high confidence (L6+ only)")
print("  • *_approved_l6plus_transitions.png")
print()
print("OTHER STATUS:")
print("  • *_rejected_distribution.png - Rejected applications")
print("  • *_rejected_transitions.png")
print("  • *_inprocess_distribution.png - In-process applications")
print("  • *_inprocess_transitions.png")
print()
print("="*80)
print("CONFIDENCE LEVELS EXPLAINED")
print("="*80)
print()
print("1. APPROVED (ALL) - Mixed confidence")
print("   • Includes all auth_status = 1")
print("   • May include intermediate approvals at low levels")
print("   • Use for baseline comparison")
print()
print("2. APPROVED (L4+) - HIGH confidence")
print("   • Only applications that reached Level 4 or higher")
print("   • ~59% of 'All Approved' for Industry Registration")
print("   • Confident these are truly final approvals")
print()
print("3. APPROVED (L4+ or Dormant 180d+) - RECOMMENDED")
print("   • Level 4+ OR no activity for 180+ days")
print("   • ~85-90% of 'All Approved'")
print("   • Best balance of completeness and confidence")
print()
print("4. APPROVED (L6+) - VERY HIGH confidence")
print("   • Only applications that reached Level 6 or higher")
print("   • Most conservative filter")
print("   • Highest confidence but smaller sample size")
print()
print("Use the 'recommended' version for most analyses!")

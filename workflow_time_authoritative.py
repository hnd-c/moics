...
print("="*80)
print("WORKFLOW TIME DISTRIBUTION - AUTHORITATIVE STATUS ANALYSIS")
print("="*80)
print()
...
# Status categories - simplified to use only authoritative status
status_categories = {
    'approved': {
        'name': 'Approved',
        'auth_statuses': ['Approved'],
        'color': 'seagreen',
        'description': 'Applications with authoritative status = Approved (Final approval granted)'
    },
    'rejected': {
        'name': 'Rejected',
    ...
    'back_for_review': {
        ...
        'color': 'orange',
        'description': 'Applications sent back for review (requires revision before resubmission)'
    },
    'inprocess': {
        'name': 'In-Process',
        'auth_statuses': ['In Process', 'Sent for recommendation', 'Sent to external office', 'Sent for committee'],
        'color': 'darkorange',
        'description': 'Applications currently being processed (active but not yet decided)'
    }
}
...
def calculate_application_data_by_status(process_name, status_category):
    ...
    # Filter applications by authoritative status
    filtered_app_ids = []
    for app_id in app_ids:
        ...
        if auth_stat in category_info['auth_statuses']:
...
print("Starting analysis with AUTHORITATIVE status (4 categories only)...")
print()
...
for process_name in processes_to_analyze:
    ...
    # Process all 4 status categories
...
print()
print("="*80)
print("STATUS CATEGORIES (AUTHORITATIVE)")
print("="*80)
print()
print("1. APPROVED")
print("   • Applications with final status = 'Approved'")
print("   • These are confirmed completed applications")
print("   • Shows time from initial submission to final approval")
print()
print("2. REJECTED")
print("   • Applications with final status = 'Rejected'")
print("   • Shows time from submission to rejection decision")
print()
print("3. BACK FOR REVIEW")
print("   • Applications with status = 'Back for review'")
print("   • These need revision/additional information")
print("   • Shows time spent before being sent back")
print("   • May be resubmitted later")
print()
print("4. IN-PROCESS")
print("   • Applications currently being processed")
print("   • Includes: 'In Process', 'Sent for recommendation',")
print("     'Sent to external office', 'Sent for committee'")
print("   • Shows time elapsed so far (not final completion time)")
print()
print("="*80)
print("FILE NAMING CONVENTION")
print("="*80)
print()
print("  {process_name}_{status}_distribution.png")
print("  {process_name}_{status}_transitions.png")
print()
print("Where {status} is one of:")
print("  - approved")
print("  - rejected")
print("  - back_for_review")
print("  - inprocess")
print()
print("Example:")
print("  industry_registration_approved_distribution.png")
print("  industry_registration_back_for_review_transitions.png")
